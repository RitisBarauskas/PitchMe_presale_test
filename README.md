...
## Примеры запуска:
```python
python main.py --filter middle_ux_designer
python main.py --filter experience_python_developer
python main.py --filter experience_python_developer --input data/profiles.json
```